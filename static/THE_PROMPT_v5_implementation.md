...
## Mission
Implement code changes and tests according to the plan, using IntelliJ MCP Steroid for edits and verification.
...
- Use IntelliJ MCP Steroid for edits, inspections, and runs.
- Run required tests in IntelliJ MCP Steroid before and after changes when applicable.
...
3. Verify IntelliJ MCP Steroid shows no new warnings/errors.
4. Re-run relevant tests in IntelliJ MCP Steroid.

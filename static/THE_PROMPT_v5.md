...
Available files:
- [run-agent.sh](https://run-agent.jonnyzzz.com/run-agent.sh) — unified agent runner
- [THE_PROMPT_v5.md](https://run-agent.jonnyzzz.com/THE_PROMPT_v5.md) — this file (orchestration workflow)
- [THE_PROMPT_v5_orchestrator.md](https://run-agent.jonnyzzz.com/THE_PROMPT_v5_orchestrator.md) — orchestrator role prompt
- [THE_PROMPT_v5_research.md](https://run-agent.jonnyzzz.com/THE_PROMPT_v5_research.md) — research role prompt
- [THE_PROMPT_v5_implementation.md](https://run-agent.jonnyzzz.com/THE_PROMPT_v5_implementation.md) — implementation role prompt
- [THE_PROMPT_v5_review.md](https://run-agent.jonnyzzz.com/THE_PROMPT_v5_review.md) — review role prompt
- [THE_PROMPT_v5_test.md](https://run-agent.jonnyzzz.com/THE_PROMPT_v5_test.md) — test role prompt
- [THE_PROMPT_v5_debug.md](https://run-agent.jonnyzzz.com/THE_PROMPT_v5_debug.md) — debug role prompt
- [THE_PROMPT_v5_monitor.md](https://run-agent.jonnyzzz.com/THE_PROMPT_v5_monitor.md) — monitor role prompt
- [monitor-agents.sh](https://run-agent.jonnyzzz.com/monitor-agents.sh) — 10-minute polling loop (background)
- [watch-agents.sh](https://run-agent.jonnyzzz.com/watch-agents.sh) — 60s polling loop for PID status
